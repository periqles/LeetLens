...
export default function LeetifyToFaceitSection() {
  ...
  return (
    <div className="ll:flex ll:w-full ll:flex-col ll:items-center">
      {!isProcessing && (
      ...
      {isOldDemo && (
        <p className="ll:mt-2 ll:mb-3 ll:text-center ll:text-yellow-500">
          {LEETIFY_OLD_DEMO_WARNING}
        </p>
      )}
      {isProcessing && !isOldDemo && (
        <LeetifyToFaceitDescription>
          <p className="ll:mt-2 ll:mb-1">
