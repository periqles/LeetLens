...
export default function FaceitToLeetifyButton() {
  ...
  return (
    <>
      {showLoginButton ? (
        <a
          className="ll:bg-gradient-upload ll:drop-shadow-glow ll:mt-3 ll:mb-3.5 ll:block ll:h-8 ll:w-full ll:rounded-sm ll:px-6 ll:py-2 ll:font-bold ll:text-white ll:brightness-100 ll:transition-all ll:duration-100 ll:hover:brightness-125"
        ...
        <div className="ll:bg-gradient-upload ll:drop-shadow-glow ll:mt-3 ll:mb-3.5 ll:flex ll:h-8 ll:w-full ll:items-center ll:justify-center ll:rounded-sm ll:gap-2">
          <svg
            aria-hidden="true"
            className="ll:h-4 ll:w-4 ll:animate-spin ll:fill-white ll:text-gray-300/60"
            viewBox="0 0 100 101"
            fill="none"
          ...
          <span className="ll:font-bold ll:text-white ll:text-xs">
        ...
        <>
          <button
            className={clsx(
              "ll:bg-gradient-upload ll:drop-shadow-glow ll:mt-3 ll:mb-3.5 ll:block ll:h-8 ll:w-full ll:rounded-sm ll:border-0 ll:px-6 ll:py-2 ll:font-bold ll:text-white ll:brightness-100 ll:transition-all ll:duration-100",
              !waitingForCountdown
                ? "ll:hover:brightness-125"
                : "ll:!cursor-progress",
            )}
          ...
          {waitingForCountdown && (
            <p className="ll:mb-5 ll:text-center ll:text-[13px] ll:text-neutral-400">
        ...
        <button
          className="ll:bg-gradient-upload ll:drop-shadow-glow ll:mt-3 ll:mb-3.5 ll:block ll:h-8 ll:w-full ll:cursor-pointer ll:rounded-sm ll:border-0 ll:px-6 ll:py-2 ll:font-bold ll:text-white ll:brightness-100 ll:transition-all ll:duration-100 ll:hover:brightness-125"
          onClick={handleClick}
        >
          UPLOAD TO LEETIFY
        </button>
        ...
        <a
          className="ll:bg-gradient-upload ll:drop-shadow-glow ll:mt-3 ll:mb-3.5 ll:flex ll:h-8 ll:w-full ll:items-center ll:justify-center ll:gap-2 ll:rounded-sm ll:px-6 ll:py-2 ll:font-bold ll:text-white ll:brightness-100 ll:transition-all ll:duration-100 ll:hover:brightness-125"
      ...
      {error && (
        <p className="ll:mb-5 ll:text-center ll:text-red-400">{error}</p>
      )}

      {warning && !loading && (
        <p className="ll:mb-5 ll:text-center ll:text-yellow-500">
          {warning}
        </p>
      )}
      ...
      {showToast && (
        <FaceitToast>
          <div className="ll:px-1.5 ll:py-2 ll:text-left ll:font-bold">
            <h2 className="ll:m-0 ll:pb-2">Match is processing on Leetify</h2>
            <p className="ll:m-0">This usually takes 2 to 15 minutes.</p>
          </div>
          <button
            className="ll:w-8 ll:rounded-sm ll:border-0 ll:bg-transparent ll:p-1 ll:text-white/60 ll:transition-colors ll:hover:bg-[#484848]/80"
      ...
      {automaticallyUpload && (
        <FaceitToast>
          <div className="ll:px-1.5 ll:py-2 ll:text-left">
            <h2 className="ll:m-0 ll:pb-2">
